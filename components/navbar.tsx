...
const navItems = [
  ...
  { label: "Lisensi & Support", href: "#value" },
]
    ...
    >
      ...
      >
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white hidden sm:block">Nexus POS</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3 ">
          <Button size="sm" className="bg-white text-zinc-950 hover:bg-zinc-200 rounded-full px-4">
            <a href="https://l1nq.com/j1WcW" target="_blank">Beli Sekarang</a>
          </Button>
        </div>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Button className="bg-white text-zinc-950 hover:bg-zinc-200 rounded-full">
              <a href="https://l1nq.com/j1WcW" target="_blank">Beli Sekarang</a>
            </Button>
          </div>
        </motion.div>
